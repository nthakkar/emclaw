...
rip_shape	= 'interface' # gaussian1dx, homogeneous, interface
...
vrip_e 		= 0.0	# replace here the value of x
vrip_m 		= vrip_e
...
prip 		= 0.0
deltan 		= prip*(np.sqrt(epso*muo)) # assumes epsilon = mu
...
# Grid - mesh settings
x_lower=0.; x_upper=500.; mx = np.floor(60*(x_upper-x_lower)/alambda)
